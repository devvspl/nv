    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-heading text-zendo-navy font-semibold">Edit Client</h2>
        ...
        <form action="{{ route('admin.our-clients.update', $ourClient) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            @method('PUT')

            <div>
                <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Client Name *</label>
                <input type="text" name="name" id="name" value="{{ old('name', $ourClient->name) }}"
            ...
            <div>
                ...
                @if($ourClient->logo_url)
                    <div class="mb-3">
                        <img src="{{ $ourClient->logo_url }}" alt="Current Logo" class="h-20 w-auto object-contain border border-gray-200 rounded p-2">
                    </div>
                @endif
            ...
            <div>
                ...
                <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $ourClient->sort_order) }}" min="0"
            ...
            <div class="flex items-center">
                <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $ourClient->is_active) ? 'checked' : '' }}
