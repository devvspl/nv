...
@section('page-description', 'Add new property category')
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-heading text-zendo-navy font-semibold">Create New Category</h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           placeholder="living-house (auto-generated if empty)">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="mb-3 p-4 border border-gray-200 rounded-lg bg-gray-50">
                        <label class="block text-xs font-medium text-gray-600 mb-2">Upload Icon File</label>
                        <input type="file" 
                               name="icon_upload" 
                               id="icon_upload"
                               accept="image/*"
