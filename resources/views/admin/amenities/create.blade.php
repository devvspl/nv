...
@section('title', 'Add New Amenity - ZendoIndia Admin')

@section('page-title', 'Add New Amenity')
@section('page-description', 'Create a new property amenity')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select name="category" required
                        ...
                        <option value="recreation" {{ old('category') == 'recreation' ? 'selected' : '' }}>Recreation</option>
                        <option value="convenience" {{ old('category') == 'convenience' ? 'selected' : '' }}>Convenience</option>
                        <option value="eco_friendly" {{ old('category') == 'eco_friendly' ? 'selected' : '' }}>Eco Friendly</option>
                    </select>
                    @error('category')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
