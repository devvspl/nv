    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-heading text-zendo-navy font-semibold">Create New Service Type</h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           placeholder="buy (auto-generated if empty)">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" 
                           ...
                           placeholder="🏠">
                    <p class="mt-1 text-sm text-gray-500">Enter an emoji or icon text</p>
                    @error('icon')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    @forelse($propertyTypes as $propertyType)
                        <label class="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-50 hover:border-zendo-gold cursor-pointer transition-colors">
                            <input type="checkbox" name="property_types[]" value="{{ $propertyType->id }}"
                                {{ in_array($propertyType->id, old('property_types', [])) ? 'checked' : '' }}
