                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div
                                            ...
                                            <span
                                                class="text-white text-xs font-semibold">{{ substr($serviceType->name, 0, 1) }}</span>
                                        </div>
                                        <div>
                                            <div class="text-sm font-medium text-gray-900">{{ $serviceType->name }}</div>
                                            @if ($serviceType->description)
                                                <div class="text-xs text-gray-500">
                                                    {{ Str::limit($serviceType->description, 40) }}</div>
                                            @endif
                                        </div>
                                    </div>
                                </td>
                    ...
                    <div class="flex justify-between items-start mb-4">
                        <div class="flex items-center flex-1">
                            <div class="w-10 h-10 bg-zendo-gold rounded-full mr-3 flex items-center justify-center">
                                <span class="text-white font-semibold">{{ substr($serviceType->name, 0, 1) }}</span>
                            </div>
                            <div class="flex-1">
                        ...
                        @canDo('service-types.edit')
                        <form action="{{ route('admin.service-types.toggle-status', $serviceType) }}" method="POST"
                            class="inline">
                            @csrf
                            @method('PATCH')
                            <button type="submit"
