    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div class="flex items-start justify-between mb-6">
            ...
            <div class="flex flex-col space-y-2">
                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ $builder->status ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <a href="mailto:{{ $builder->email }}" class="text-base font-medium text-blue-600 hover:text-blue-800">
                    {{ $builder->email }}
                </a>
            </div>
            @endif
            ...
            <div>
                ...
                <a href="tel:{{ $builder->phone }}" class="text-base font-medium text-blue-600 hover:text-blue-800">
                    {{ $builder->phone }}
                </a>
            </div>
            @endif
            ...
            <div>
                ...
                <a href="{{ $builder->website }}" target="_blank" class="text-base font-medium text-blue-600 hover:text-blue-800">
                    {{ $builder->website }}
                </a>
            </div>
            @endif
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        @if($builder->properties->count() >= 10)
            <div class="mt-4 text-center">
                <p class="text-sm text-gray-600">Showing latest 10 properties. Total: {{ $builder->properties->count() }}</p>
            </div>
        @endif
    </div>
    @else
