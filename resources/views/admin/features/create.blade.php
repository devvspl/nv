...
@section('page-description', 'Add new feature to "Why Choose Us" section')
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-heading text-zendo-navy font-semibold">Create New Feature</h2>
        ...
        <form action="{{ route('admin.features.store') }}" method="POST" class="p-6 space-y-6" enctype="multipart/form-data">
            @csrf
            ...
            <div>
                ...
                <select name="tag" 
                    ...
                    <option value="why-choose-us" {{ old('tag') == 'why-choose-us' ? 'selected' : '' }}>Why Choose Us</option>
                    <option value="our-services" {{ old('tag') == 'our-services' ? 'selected' : '' }}>Our Services</option>
                </select>
