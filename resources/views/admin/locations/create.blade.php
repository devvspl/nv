    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-heading text-zendo-navy font-semibold">Create New Location</h2>
        ...
        <form action="{{ route('admin.locations.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
