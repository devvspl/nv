...
@section('content')
    ...
    <section class="relative bg-zendo-navy min-h-screen flex flex-col items-center justify-center pt-20 text-center">
        ...
        <div class="absolute inset-0 z-0">
            <video class="w-full h-full object-cover brightness-75" autoplay muted loop playsinline
                poster="{{ asset('main/images/zendo-home-bg.png') }}">
                <source src="{{ asset('main/video/home-bg.mp4') }}" type="video/mp4">
        ...
        <div class="relative z-10 max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
            <div>
                <h1 class="text-4xl sm:text-5xl lg:text-7xl font-heading text-white leading-tight animate-on-scroll fade-in-up hero-text-shadow"
                    ...
                    Find Your Perfect <span class="text-zendo-gold">Property</span>
                </h1>
                <p class="mt-6 text-lg sm:text-xl text-gray-200 font-body max-w-2xl mx-auto animate-on-scroll fade-in-up hero-text-shadow"
                    ...
                    Discover the best properties to buy, lease, or invest in across India.
                    Your new beginning starts here with ZENDO.
                </p>
            </div>

            <!-- Search Bar -->
            <div class="w-full max-w-8xl mt-12 animate-on-scroll fade-in-up" style="--animation-delay: 0.3s;">

                <!-- Tabs -->
                <div class="flex justify-center flex-wrap gap-2 mb-2">
                    <!-- Buy -->
                    <button
                        class="search-tab-button active group relative px-8 py-3 rounded-t-lg bg-white text-zendo-navy font-highlight font-bold"
                        data-tab="buy">
                        Buy
                        <div
                    ...
                    <!-- Lease -->
                    <button
                        class="search-tab-button group relative px-8 py-3 rounded-t-lg bg-gray-200/80 backdrop-blur-sm text-gray-700 hover:bg-white hover:text-zendo-navy font-highlight font-semibold"
                        data-tab="lease">
                        Lease
                        <div
                            class="tab-pointer hidden absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-full w-0 h-0 border-l-8 border-l-transparent border-r-8 border-r-transparent border-t-8 border-t-white">
                        </div>
                    </button>
                ...
                <div class="bg-white rounded-xl shadow-2xl">
                    <div class="p-4 sm:p-6">
                        ...
                        <!-- Global Search Form -->
                        <form id="globalSearchForm" class="hidden">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">

                                <!-- Global keyword -->
                                <div class="w-full">
                                    <label for="global-search" class="sr-only">Global Search</label>
                                    <input type="text" id="global-search" name="q"
                                        placeholder="Search property, city, area, keyword..."
                                        class="w-full px-4 py-3 rounded-md border border-gray-300 focus:border-zendo-navy focus:ring-1 focus:ring-zendo-navy text-gray-700 font-body transition-colors">
                                </div>
                            ...
                            <li class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 font-body leading-relaxed">Please add features with
                                        'our-services' tag from admin panel.</p>
                                </div>
                            </li>
                        @endforelse
                    </ul>
    ...
    <section class="bg-pattern-light py-24 animate-on-scroll fade-in-up">
        <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Section Header -->
            <div class="text-center mb-16">
                <span class="section-subheading">Explore Cities</span>
                <h2 class="font-heading text-zendo-navy">
                    Popular Cities
                </h2>
                <p class="text-lg text-gray-600 font-body max-w-2xl mx-auto">
            ...
            <!-- Cities Grid -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 card-grid-container">

                @forelse($cities as $city)
                    <!-- City Card: {{ $city->name }} -->
                    <a href="{{ $city->link }}"
                        class="city-card card-item relative overflow-hidden rounded-lg shadow-xl group cursor-pointer">
                        <img src="{{ $city->image_url }}" alt="{{ $city->name }}"
                            class="city-image w-full h-64 object-cover">
                        <div class="overlay absolute inset-0 bg-black/40 flex items-end p-6">
                            <div class="text-white">
                                <h3 class="text-xl font-semibold font-heading mb-1">{{ $city->name }}</h3>
                                <p class="text-sm font-body opacity-90">{{ $city->formatted_property_count }}</p>
                            </div>
                        </div>
                    </a>
                @empty
                ...
                @empty
                    ...
                    <div class="col-span-full text-center py-12">
                        <p class="text-gray-600 font-body text-lg">No features available. Please add features with
                            'why-choose-us' tag from admin panel.</p>
                    </div>
                @endforelse
            </div>
        </div>
                    ...
                    <a href="#">
                        ...
                        <div class="p-6">
                            <h3
                                ...
                                Benefits of Real Estate Template</h3>
                ...
                <div class="blog-card card-item bg-white rounded-lg shadow-lg overflow-hidden border border-gray-100">
                    <a href="#">
                        ...
                        <div class="p-6">
                            <h3
                                class="text-xl font-semibold font-heading text-zendo-navy hover:text-zendo-gold transition-colors mb-3">
                                Important of Real Estate Developer</h3>
                            <p class="text-gray-600 font-body text-sm leading-relaxed mb-4 line-clamp-3">Real estate
                                development involves numerous tasks, including creating project proposals, contracts...</p>
                            <div class="flex items-center text-xs text-gray-500 font-body">
                                <span>BY ROBERT HAVEN</span>
                                <span class="mx-2">|</span>
                ...
                <div class="blog-card card-item bg-white rounded-lg shadow-lg overflow-hidden border border-gray-100">
                    <a href="#">
                        ...
                        <div class="p-6">
                            <h3
                                class="text-xl font-semibold font-heading text-zendo-navy hover:text-zendo-gold transition-colors mb-3">
                                What Are Good Template Features?</h3>
                            <p class="text-gray-600 font-body text-sm leading-relaxed mb-4 line-clamp-3">A good template
                                should have a clean and intuitive design, making it easy for users to navigate...</p>
                            <div class="flex items-center text-xs text-gray-500 font-body">
                                <span>BY ROBERT HAVEN</span>
                                <span class="mx-2">|</span>
        ...
        <div class="lux-real-container">
            ...
            <div class="lux-real-left">
                ...
                <p class="lux-content">Luxury residences located in top neighbourhoods with world-class amenities and
                    premium lifestyle experiences.</p>
                            ...
                            <div class="faq-item">
                                ...
                                <div x-show="open === 1" x-collapse x-cloak class="faq-answer">
                                    <p class="font-body text-gray-600 px-6 pb-6 pt-4">Our properties typically include
                                        high-speed Wi-Fi, modern kitchen appliances, and access to community amenities.</p>
                                </div>
                            </div>
                            <div class="faq-item">
                            ...
                            <div class="faq-item">
                                ...
                                <div x-show="open === 3" x-collapse x-cloak class="faq-answer">
                                    <p class="font-body text-gray-600 px-6 pb-6 pt-4">We do not directly provide transfer
                                        services, but we can recommend trusted local partners for your convenience.</p>
                                </div>
                            </div>
                            <div class="faq-item">
                                ...
                                <div x-show="open === 4" x-collapse x-cloak class="faq-answer">
                                    <p class="font-body text-gray-600 px-6 pb-6 pt-4">Many of our properties are
                                        ...
                                        suitable options for your stay.</p>
                                </div>
                            </div>
                        @endforelse
                    </div>
