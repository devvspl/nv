...
.about-banner-overlay{position:absolute;inset:0;background:rgb(0 0 0 / 62%);}
...
#sgdxp-page{max-width:1200px;margin:40px auto;padding:0 15px 15px;}
.sgdxp-header-row{display:flex;justify-content:space-between;align-items:flex-start;gap:24px;margin-bottom:24px;}
.sgdxp-header-left{flex:1 1 auto;min-width:0;}
.sgdxp-badges{display:flex;flex-wrap:wrap;gap:8px;margin-bottom:8px;}
.sgdxp-badge{display:inline-flex;align-items:center;padding:4px 12px;border-radius:999px;font-size:12px;font-weight:600;white-space:nowrap;}
.sgdxp-badge-status{background:var(--zendo-gold);color:#fff;}
.sgdxp-title{font-size:42px!important;color:var(--zendo-navy);margin-bottom:6px;}
.sgdxp-location-line{display:flex;align-items:center;gap:8px;font-size:14px;color:#555;}
.sgdxp-header-right{flex:0 0 auto;text-align:right;}
.sgdxp-starting-price-label{font-size:12px;text-transform:uppercase;letter-spacing:.08em;color:#777;margin-bottom:4px;}
.sgdxp-starting-price-value{font-size:26px;color:var(--zendo-gold);}
#sgdxp-main{display:grid;grid-template-columns:minmax(0,7fr) minmax(0,3fr);gap:24px;}

.sgdxp-image-card{background:#fff;border-radius:18px;overflow:hidden;box-shadow:0 14px 35px rgba(0,0,0,.07);}
.sgdxp-image-wrapper{position:relative;padding-top:62%;overflow:hidden;}
.sgdxp-image-wrapper img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;}

.sgdxp-contact-card{
  background:var(--zendo-navy);color:#f8f9fb;border-radius:18px;
  padding:24px;display:flex;flex-direction:column;
  box-shadow:0 18px 45px rgba(0,0,0,.4);
}
.sgdxp-contact-card h2{font-size:22px;margin-bottom:6px;color:#fff;}
.sgdxp-contact-subtext{font-size:13px;color:#d2d8e6;margin-bottom:22px;}
.sgdxp-contact-row{display:flex;gap:10px;margin-bottom:14px;}
.sgdxp-contact-icon{
  width:28px;height:28px;border-radius:999px;
  display:flex;align-items:center;justify-content:center;
  background:rgba(255,255,255,.06);
}
.sgdxp-contact-label{font-weight:600;font-size:14px;text-transform:uppercase;color:#f4e1bc;margin-bottom:4px;}
.sgdxp-contact-details{font-size:14px;color:#e6edf8;}
.sgdxp-call-number{font-size:15px;font-weight:600;}
.sgdxp-request-btn{margin-top:auto;padding-top:12px;}
.sgdxp-request-btn button{
  width:100%;border-radius:999px;border:none;padding:14px 18px;
  font-size:15px;font-weight:600;cursor:pointer;
  background:var(--zendo-gold);color:#fff;
  box-shadow:0 14px 28px rgba(0,0,0,.25);
}
.sgdxp-request-btn button:hover{background:#a1814b;transform:translateY(-2px);}

#sg2-section{max-width:1200px;margin:40px auto;padding:0 16px 15px;}
.sg2-row{display:grid;grid-template-columns:minmax(0,7fr) minmax(0,3fr);gap:28px;align-items:flex-start;}
.sg2-usp-card{background:#fff;border-radius:18px;box-shadow:0 14px 32px rgba(0,0,0,.06);padding:18px 24px;margin-bottom:28px;}
.sg2-usp-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px;}
.sg2-usp-item-label{font-size:14px;text-transform:uppercase;letter-spacing:.08em;color:var(--zendo-gold);margin-bottom:4px;font-weight:800;}
.sg2-usp-item-value{font-size:16px;font-weight:700;color:var(--zendo-blue);}
.sg2-hr{height:1px;border:none;background:#e2e6ed;margin-bottom:18px;}
.sg2-title-main{font-size:32px!important;font-weight:600;color:var(--zendo-navy);margin-bottom:16px;}
.sg2-overview-text{font-size:17px;color:#444;margin-bottom:24px;}
.sg2-subtitle{font-size:25px;font-weight:600;color:#0b2c3d;margin-bottom:12px;font-family:'Forum';}
.sg2-reasons{list-style:none;padding:0;margin:0 0 26px;}
.sg2-reasons li{display:flex;align-items:flex-start;gap:10px;font-size:17px;color:#222;margin-bottom:8px;}
.sg2-bullet-icon{flex:0 0 auto;margin-top:3px;}

.sg2-form-card{
  background:var(--zendo-navy);color:#f6fbff;border-radius:18px;padding:26px 26px 30px;
  box-shadow:0 18px 45px rgba(0,0,0,.4);
  position:sticky;top:80px;height:fit-content;z-index:10;
}
.sg2-form-title{font-size:30px!important;margin-bottom:6px;}
.sg2-form-subtext{font-size:14px;color:#d0deeb;margin-bottom:22px;}
.sg2-form-group{margin-bottom:14px;}
.sg2-input,.sg2-textarea{
  width:100%;border-radius:8px;border:1px solid #234056;background:#123448;color:#fff;
  padding:12px 14px;font-size:14px;outline:none;
  transition:border-color .2s ease, box-shadow .2s ease;
}
.sg2-input::placeholder,.sg2-textarea::placeholder{color:#9fb3c5;}
.sg2-input:focus,.sg2-textarea:focus{border-color:var(--zendo-gold);box-shadow:0 0 0 1px rgba(179,147,89,.5);}
.sg2-textarea{min-height:110px;resize:vertical;}
.sg2-btn-wrap{margin-top:18px;}
.sg2-btn{
  width:100%;border-radius:999px;border:none;padding:14px 18px;font-size:15px;font-weight:700;
  cursor:pointer;background:var(--zendo-gold);color:#fff;
  box-shadow:0 16px 34px rgba(0,0,0,.35);
  transition:background .2s ease, transform .2s ease, box-shadow .2s ease;
}
.sg2-btn:hover{background:#a1814b;transform:translateY(-2px);box-shadow:0 20px 40px rgba(0,0,0,.4);}

.apw-table-wrap{
  display:block;width:100%;max-width:100%;overflow-x:auto;overflow-y:hidden;
  -webkit-overflow-scrolling:touch;overscroll-behavior-x:contain;
  border-radius:12px;background:var(--zendo-bg);
}
.apw-table{width:100%;min-width:720px;border-collapse:collapse;background:var(--zendo-bg);font-family:inherit;}
.apw-table thead th{
  background:var(--zendo-navy);color:var(--zendo-bg);padding:14px 12px;text-align:left;
  font-weight:600;border:1px solid var(--zendo-gold);white-space:nowrap;
}
.apw-table td{padding:12px;border:1px solid var(--zendo-gold);color:var(--zendo-navy);font-size:14px;white-space:nowrap;}
.apw-table tbody tr:nth-child(even){background:rgba(179,147,89,.08);}
.apw-table tbody tr:hover{background:rgba(179,147,89,.18);transition:.2s ease;}
.apw-table td:first-child{font-weight:600;text-align:center;width:80px;}

#sg-gallery-similar{max-width:1200px;margin:40px auto;padding:0 16px 15px;}
.sg-gs-row{display:grid;grid-template-columns:minmax(0,7fr) minmax(0,3fr);gap:28px;align-items:flex-start;}
.sg-gallery-box{background:#fff;padding:5px;border-radius:16px;}
.sg-gallery-title{font-size:32px!important;font-weight:600;color:var(--zendo-blue);margin-bottom:16px;}
.sg-slider{position:relative;overflow:hidden;border-radius:12px;}
.sg-slide{display:none;width:100%;}
.sg-slide img{width:100%;border-radius:12px;object-fit:cover;}
.sg-prev,.sg-next{
  position:absolute;top:50%;transform:translateY(-50%);
  background:#ffffff91;color:var(--zendo-blue);
  width:38px;height:38px;border-radius:50%;
  display:flex;align-items:center;justify-content:center;cursor:pointer;
  font-size:40px;z-index:5;border:2px solid #fff;padding-bottom:5px;
}
.sg-prev{left:10px;}
.sg-next{right:10px;}
.sg-similar-box{
  background:var(--zendo-navy);color:#f6fbff;border-radius:18px;
  padding:26px 26px 30px;box-shadow:0 18px 45px rgba(0,0,0,.4);margin-top:14px;
}
.sg-similar-title{font-size:32px!important;color:#fff;margin-bottom:16px;}
.sg-similar-card{background:var(--zendo-navy);border-radius:16px;padding:15px 0;box-shadow:0 10px 28px rgba(0,0,0,.08);margin-bottom:20px;}
.sg-similar-card img{width:100%;border-radius:14px;margin-bottom:12px;}
.sg-similar-name{font-size:18px;font-weight:600;color:#fff;margin-bottom:14px;text-align:left;}
.sg-similar-info-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:12px;font-size:14px;}
.sg-similar-label{color:#fff;font-weight:600;font-size:13px;}
.sg-badge{background:var(--zendo-gold);border:1px solid var(--zendo-gold);color:#fff;font-size:12px;padding:4px 10px;border-radius:6px;display:inline-block;margin-top:4px;}

#newRowFaqMap{max-width:1200px;margin:50px auto;padding:0 16px;}
.newRow{display:grid;grid-template-columns:minmax(0,7fr) minmax(0,3fr);gap:28px;align-items:flex-start;}
.nr-faq-title{font-size:32px!important;font-weight:600;color:var(--zendo-blue);margin-bottom:16px;}
.nr-faq-box{background:#fff;border-radius:14px;overflow:hidden;box-shadow:0 12px 30px rgba(0,0,0,.07);}
.nr-faq-item{border-bottom:1px solid #e5e8ef;}
.nr-faq-item:last-child{border-bottom:none;}
.nr-faq-item summary{
  padding:14px 16px;cursor:pointer;font-size:18px;color:var(--zendo-gold);
  list-style:none;position:relative;margin-bottom:5px;
}
.nr-faq-item summary::-webkit-details-marker{display:none;}
.nr-faq-item summary::after{
  content:"+";position:absolute;right:16px;top:50%;
  transform:translateY(-50%);font-size:20px;color:var(--zendo-gold);
}
.nr-faq-item[open] summary::after{content:"–";}
.nr-faq-body{padding:0 16px 16px;font-size:16px;color:#444;}

.nr-map-card{background:#fff;border-radius:16px;padding:0 10px 14px;box-shadow:0 12px 30px rgba(0,0,0,.08);}
.nr-map-title{font-size:32px!important;font-weight:600;color:var(--zendo-blue);margin-bottom:16px;font-family:'Forum',cursive;padding-top:5px;}
.nr-map-address{font-size:14px;margin-bottom:12px;color:#222;}
.nr-map-iframe{border:2px solid #f8f9fa;border-radius:14px;overflow:hidden;}
.nr-map-iframe iframe{width:100%;height:260px;border:none;}

#sg-mobile-sidebar-stack{display:none;max-width:1200px;margin:30px auto 0;padding:0 16px 24px;}

@media (max-width:992px){
  .sgdxp-header-row{flex-direction:column;}
  #sgdxp-main{grid-template-columns:1fr;}
  .sg2-row{grid-template-columns:1fr;}
  .sg2-usp-grid{grid-template-columns:repeat(2,minmax(0,1fr));}
  .sg-gs-row{grid-template-columns:1fr;}
  .newRow{grid-template-columns:1fr;}
  #sg-mobile-sidebar-stack{display:block;}
  #sg-mobile-sidebar-stack .sg-mobile-stack-item{margin-top:18px;}
  .sgdxp-contact-card,.sg2-form-card,.sg-similar-box,.nr-map-card{display:none !important;}
  #sg-mobile-sidebar-stack .sgdxp-contact-card{display:flex !important;}
  #sg-mobile-sidebar-stack .sg2-form-card{display:block !important;position:static !important;top:auto !important;}
  #sg-mobile-sidebar-stack .sg-similar-box{display:block !important;}
  #sg-mobile-sidebar-stack .nr-map-card{display:block !important;}
}
</style>
@endsection
...
<div id="inquiry-popup-overlay" class="inquiry-popup-overlay hidden">
    <div class="inquiry-popup-content">
        <div class="inquiry-popup-header">
            ...
            <p class="inquiry-popup-subtitle">Our expert team will provide you with floor plans, pricing, and a free consultation. Fill in your details below.</p>
        </div>
    ...
    <div class="sgdxp-header-row">
        <div class="sgdxp-header-left">
            ...
            <div class="sgdxp-location-line">
                ...
                <span>
                    {{ $property->address }}
                    @isset($property->location), {{ $property->location->name }}@endisset
                    @isset($property->city), {{ $property->city->name }}@endisset
                </span>
    ...
    <div id="sgdxp-main">
        <div class="sgdxp-image-card">
            <div class="sgdxp-image-wrapper">
                ...
                @else
                    <img src="https://images.unsplash.com/photo-1564013799919-ab600027ffc6?auto=format&fit=crop&w=1200&q=70" alt="{{ $property->title }}">
                @endif
            </div>
        </div>
                ...
                <div class="sgdxp-contact-section">
                    ...
                    <div class="sgdxp-contact-row">
                        ...
                        <div>
                            ...
                            <div class="sgdxp-contact-details"><p>info@zendoindia.com</p></div>
                        </div>
                    </div>
                    ...
                    <div class="sgdxp-contact-row">
                        ...
                        <div>
                            ...
                            <div class="sgdxp-contact-details"><p class="sgdxp-call-number">+91 97323 00007</p></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="sg2-usp-card">
                <div class="sg2-usp-grid">
                    ...
                    <div>
                        ...
                        <div class="sg2-usp-item-value">{{ $property->carpet_area ? number_format($property->carpet_area) . ' Sq ft' : 'N/A' }}</div>
                    </div>
                    <div>
                        <div class="sg2-usp-item-label">Possession</div>
                        <div class="sg2-usp-item-value">{{ $property->specifications->possession_date ?? 'On Request' }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="apw-table-wrap">
                <table class="apw-table">
                    ...
                    <tbody>
                        ...
                        <tr><td>{{ $srNo++ }}</td><td>RERA Number</td><td>{{ $property->specifications->rera_number }}</td></tr>
                        @endif
                        @if($property->specifications->total_floors)
                        <tr><td>{{ $srNo++ }}</td><td>Total Floors</td><td>{{ $property->specifications->total_floors }}</td></tr>
                        @endif
                        @if($property->specifications->floor_number)
                        <tr><td>{{ $srNo++ }}</td><td>Floor Number</td><td>{{ $property->specifications->floor_number }}</td></tr>
                        @endif
                        @if($property->specifications->facing)
                        <tr><td>{{ $srNo++ }}</td><td>Facing</td><td>{{ $property->specifications->facing }}</td></tr>
                        @endif
                        @if($property->specifications->furnishing_status)
                        <tr><td>{{ $srNo++ }}</td><td>Furnishing Status</td><td>{{ $property->specifications->furnishing_status }}</td></tr>
                        @endif
                        @if($property->specifications->parking)
                        <tr><td>{{ $srNo++ }}</td><td>Parking</td><td>{{ $property->specifications->parking }}</td></tr>
                        @endif
                        @if($property->specifications->possession_date)
                        <tr><td>{{ $srNo++ }}</td><td>Possession Date</td><td>{{ $property->specifications->possession_date }}</td></tr>
                        @endif
                    </tbody>
                </table>
            </div>
        ...
        <div class="sg-similar-box">
            ...
            <div class="sg-similar-card">
                @if($similar->mainImage)
                    <img src="{{ asset('storage/' . $similar->mainImage->image_path) }}" alt="{{ $similar->title }}">
                @else
                    <img src="https://images.unsplash.com/photo-1564013799919-ab600027ffc6?auto=format&fit=crop&w=400&q=70" alt="{{ $similar->title }}">
                @endif
                <div class="sg-similar-name">{{ $similar->title }}</div>

                <div class="sg-similar-info-grid">
                    <div><div class="sg-similar-label">Location</div>{{ $similar->city->name ?? 'N/A' }}</div>
                    <div><div class="sg-similar-label">Type</div>{{ $similar->propertyType->name ?? 'N/A' }}</div>
                    <div><div class="sg-similar-label">Price</div>{{ $similar->formatted_price }}</div>
                    <div><div class="sg-similar-label">Area</div>{{ $similar->carpet_area ? number_format($similar->carpet_area) . ' Sq ft' : 'N/A' }}</div>
                </div>
    ...
    <div class="newRow">
            ...
            <div class="nr-faq-box">
                ...
                <details class="nr-faq-item">
                    ...
                    <div class="nr-faq-body">
                        The project is located at {{ $property->address }}@isset($property->location), {{ $property->location->name }}@endisset @isset($property->city), {{ $property->city->name }}@endisset.
                    </div>
                </details>
                <details class="nr-faq-item">
                    <summary>Which configurations are available?</summary>
                    <div class="nr-faq-body">{{ $property->bhk ? $property->bhk->name : 'Various configurations' }} are available in this property.</div>
                </details>
                <details class="nr-faq-item">
                    <summary>When is the possession?</summary>
                    <div class="nr-faq-body">{{ $property->specifications->possession_date ?? 'Please contact us for possession details.' }}</div>
                </details>
                <details class="nr-faq-item">
                    <summary>Does the project include amenities?</summary>
                    <div class="nr-faq-body">Yes, it includes {{ $property->amenities->pluck('name')->take(5)->implode(', ') }}{{ $property->amenities->count() > 5 ? ' and more' : '' }}.</div>
                </details>
                <details class="nr-faq-item">
                    <summary>How do I request pricing or a site visit?</summary>
                    <div class="nr-faq-body">You can request a callback using the form on this page or contact our sales team directly at +91 97323 00007.</div>
                </details>
                @endforelse
            </div>
        </div>
        ...
        <aside class="nr-map-card">
            ...
            <p class="nr-map-address">
                <strong>Address:</strong> {{ $property->address }}@isset($property->location), {{ $property->location->name }}@endisset @isset($property->city), {{ $property->city->name }}@endisset
            </p>
            <div class="nr-map-iframe">
                ...
                @elseif($property->latitude && $property->longitude)
                    ...
                    <iframe
                        ...
                        width="100%" height="260" style="border:0;border-radius:14px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                @else
                    <!-- No map data available -->
                    <div style="width:100%;height:260px;border-radius:14px;background:#f3f4f6;display:flex;align-items:center;justify-content:center;color:#9ca3af;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    popupForm.addEventListener('submit', function(e) {
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                // Show error message
                popupErrorMsg.textContent = data.message || 'Something went wrong. Please try again.';
    ...
    if (callbackModalForm && callbackModalSubmitBtn) {
        ...
        callbackModalForm.addEventListener('submit', function(e) {
            ...
            .then(data => {
                // Reset button state
                if (callbackModalBtnText) callbackModalBtnText.style.display = 'inline-block';
                if (callbackModalBtnLoading) callbackModalBtnLoading.style.display = 'none';
                callbackModalSubmitBtn.disabled = false;
                
                if (data.success) {
                    // Show success message
                    if (callbackModalSuccessMsg) callbackModalSuccessMsg.style.display = 'block';
                    ...
                    setTimeout(() => {
                        if (callbackModalOverlay) callbackModalOverlay.classList.add('hidden');
                        document.body.style.overflow = 'auto';
                        if (callbackModalSuccessMsg) callbackModalSuccessMsg.style.display = 'none';
                    }, 2000);
                } else {
                    ...
                    if (callbackModalErrorMsg) {
                        callbackModalErrorMsg.textContent = data.message || 'Something went wrong. Please try again.';
            ...
            .catch(error => {
                ...
                // Show error message
                if (callbackModalErrorMsg) {
                    callbackModalErrorMsg.textContent = 'Something went wrong. Please try again.';
                    callbackModalErrorMsg.style.display = 'block';
                }
        ...
        form.addEventListener('submit', function(e) {
            ...
            .then(data => {
                ...
                if (data.success) {
                    // Show success message
                    if (successMsg) {
                        successMsg.textContent = data.message || 'Thank you! We\'ll contact you shortly.';
